...
# Structure
```
~/app/bookstore/{BACKEND_REPO}
~/app/bookstore-frontend/{FRONTEND_REPO}
```
...
mkdir bookstore
cd bookstore
git clone https://github.com/Akej24/bookstore
git clone https://github.com/Akej24/bookstore-frontend
