...
import com.bookstoreapplication.bookstore.adapters.user.UserRepository;
import com.bookstoreapplication.bookstore.domain.user.exception.EmailTakenException;
